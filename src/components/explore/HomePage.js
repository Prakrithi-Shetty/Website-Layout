    ...
    return (
        ...
        <div className="theme-hero-area">
          <div className="theme-hero-area-bg-wrap">
            <div className="theme-hero-area-bg theme-hero-area-bg-blur" style={{backgroundImage: 'url(./img/1800x500.png)'}} />
            <div className="theme-hero-area-mask theme-hero-area-mask-strong" />
          </div>
          <div className="theme-hero-area-body">
            <div className="container">
              <div className="_pb-100 _pt-150 _pv-mob-60">
                <div className="theme-search-area theme-search-area-stacked">
                  <div className="theme-search-area-header _c-w">
                    <h1 className="theme-search-area-title theme-search-area-title-lg">Search for
                      <br />Travel Expericences
                    </h1>
                    <p className="theme-search-area-subtitle">Explore 560,000+ travel expericences from all over the world</p>
                  </div>
                  <div className="theme-search-area-form" id="hero-search-form">
                    <div className="row" data-gutter="none">
                      ...
                      <div className="col-md-1 ">
                        <button className="theme-search-area-submit _mt-0 theme-search-area-submit-glow theme-search-area-submit-curved theme-search-area-submit-no-border">
                  ...
                  <div className="row row-col-mob-gap" data-gutter={60}>
                    <div className="col-md-3 ">
                      <div className="feature">
                        <i className="feature-icon _mr-20 feature-icon-white feature-icon-xl fa fa-trophy" />
                        <div className="feature-caption _c-w">
                          <h5 className="feature-title _mb-10">Gifts &amp; Rewards</h5>
                          <p className="feature-subtitle _op-06">Get even more from our service. Spend less and travel more</p>
                        </div>
                      </div>
                    </div>
                    <div className="col-md-3 ">
                      <div className="feature">
                        <i className="feature-icon _mr-20 feature-icon-white feature-icon-xl fa fa-credit-card" />
                        <div className="feature-caption _c-w">
                          <h5 className="feature-title _mb-10">Best prices</h5>
                          <p className="feature-subtitle _op-06">We are comparing hundreds travel websites to find best price for you</p>
                        </div>
                      </div>
                    </div>
                    <div className="col-md-3 ">
                      <div className="feature">
                        <i className="feature-icon _mr-20 feature-icon-white feature-icon-xl fa fa-users" />
                        <div className="feature-caption _c-w">
                          <h5 className="feature-title _mb-10">3.5m Travelers</h5>
                          <p className="feature-subtitle _op-06">Enjoyed our service from all around the world</p>
                        </div>
                      </div>
                    </div>
                    <div className="col-md-3 ">
                      <div className="feature">
                        <i className="feature-icon _mr-20 feature-icon-white feature-icon-xl fa fa-calendar" />
                        <div className="feature-caption _c-w">
                          <h5 className="feature-title _mb-10">Trip Manager</h5>
                          <p className="feature-subtitle _op-06">Be in control with your trips by using our free and award winning manager</p>
                        </div>
                      </div>
                    </div>
                  </div>
        ...
        <div className="theme-page-section theme-page-section-xl theme-page-section-gray">
          <div className="container">
            <div className="theme-page-section-header _ta-l">
              <h5 className="theme-page-section-title">Explore Expericences</h5>
              <p className="theme-page-section-subtitle">Discover travel expericences by category</p>
            </div>
            <div className="row row-col-gap" data-gutter={10}>
              <div className="col-md-3 ">
                <div className="banner _br-4 banner-sqr banner-animate banner-animate-zoom-in banner-animate-very-slow banner-animate-mask-out">
                  <div className="banner-bg" style={{backgroundImage: 'url(./img/800x600.png)'}} />
                  <a className="banner-link" href="#" />
                  <div className="banner-caption _pt-60 banner-caption-bottom banner-caption-grad">
                    <h5 className="banner-title _tt-uc _fs-sm _fw-b">Workshops</h5>
                    <p className="banner-subtitle _fw-n">Cursus viverra sagittis</p>
                  </div>
                </div>
              </div>
              <div className="col-md-3 ">
                <div className="banner _br-4 banner-sqr banner-animate banner-animate-zoom-in banner-animate-very-slow banner-animate-mask-out">
                  ...
                  <a className="banner-link" href="#" />
                  <div className="banner-caption _pt-60 banner-caption-bottom banner-caption-grad">
                    <h5 className="banner-title _tt-uc _fs-sm _fw-b">Concerts</h5>
                    <p className="banner-subtitle _fw-n">Egestas mauris lacinia</p>
                  </div>
                </div>
              </div>
              <div className="col-md-3 ">
                <div className="banner _br-4 banner-sqr banner-animate banner-animate-zoom-in banner-animate-very-slow banner-animate-mask-out">
                  ...
                  <a className="banner-link" href="#" />
                  <div className="banner-caption _pt-60 banner-caption-bottom banner-caption-grad">
                    <h5 className="banner-title _tt-uc _fs-sm _fw-b">Arts</h5>
                    <p className="banner-subtitle _fw-n">Vivamus consectetur est</p>
                  </div>
                </div>
              </div>
              <div className="col-md-3 ">
                <div className="banner _br-4 banner-sqr banner-animate banner-animate-zoom-in banner-animate-very-slow banner-animate-mask-out">
                  ...
                  <a className="banner-link" href="#" />
                  <div className="banner-caption _pt-60 banner-caption-bottom banner-caption-grad">
                    <h5 className="banner-title _tt-uc _fs-sm _fw-b">Food &amp; Drink</h5>
                    <p className="banner-subtitle _fw-n">Fermentum felis penatibus</p>
                  </div>
                </div>
              </div>
              <div className="col-md-3 ">
                <div className="banner _br-4 banner-sqr banner-animate banner-animate-zoom-in banner-animate-very-slow banner-animate-mask-out">
                  ...
                  <a className="banner-link" href="#" />
                  <div className="banner-caption _pt-60 banner-caption-bottom banner-caption-grad">
                    <h5 className="banner-title _tt-uc _fs-sm _fw-b">Nature</h5>
                    <p className="banner-subtitle _fw-n">Ultricies pulvinar nam</p>
                  </div>
                </div>
              </div>
              <div className="col-md-3 ">
                <div className="banner _br-4 banner-sqr banner-animate banner-animate-zoom-in banner-animate-very-slow banner-animate-mask-out">
                  ...
                  <a className="banner-link" href="#" />
                  <div className="banner-caption _pt-60 banner-caption-bottom banner-caption-grad">
                    <h5 className="banner-title _tt-uc _fs-sm _fw-b">History</h5>
                    <p className="banner-subtitle _fw-n">Sollicitudin facilisis iaculis</p>
                  </div>
                </div>
              </div>
              <div className="col-md-3 ">
                <div className="banner _br-4 banner-sqr banner-animate banner-animate-zoom-in banner-animate-very-slow banner-animate-mask-out">
                  ...
                  <a className="banner-link" href="#" />
                  <div className="banner-caption _pt-60 banner-caption-bottom banner-caption-grad">
                    <h5 className="banner-title _tt-uc _fs-sm _fw-b">Entertainment</h5>
                    <p className="banner-subtitle _fw-n">Euismod volutpat senectus</p>
                  </div>
                </div>
              </div>
              <div className="col-md-3 ">
                <div className="banner _br-4 banner-sqr banner-animate banner-animate-zoom-in banner-animate-very-slow banner-animate-mask-out">
                  ...
                  <a className="banner-link" href="#" />
                  <div className="banner-caption _pt-60 banner-caption-bottom banner-caption-grad">
                    <h5 className="banner-title _tt-uc _fs-sm _fw-b">Nightlife</h5>
                    <p className="banner-subtitle _fw-n">Hac adipiscing vivamus</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="container _pv-60">
          <div className="theme-page-section _pb-0 _pt-0 theme-page-section-lg">
            <div className="theme-page-section-header _ta-l _mb-20">
              <h5 className="theme-page-section-title theme-page-section-title-sm">Best Expericences in New York</h5>
              <a className="theme-page-section-header-link _tt-n theme-page-section-header-link-rb" href="#">+ Find More</a>
            </div>
            <div className="theme-inline-slider row" data-gutter={10}>
              <div className="owl-carousel" data-items={5} data-loop="true" data-nav="true">
                <div className="theme-inline-slider-item">
                  <div className="banner _br-4 banner-sqr banner-animate banner-animate-mask-in">
                    <div className="banner-bg" style={{backgroundImage: 'url(./img/400x400.png)'}} />
                    <div className="banner-mask" />
                    <a className="banner-link" href="#" />
                    <div className="banner-caption _ph-15 _pb-15 _pt-60 banner-caption-bottom banner-caption-grad">
                      <h5 className="banner-title _fw-b _fs-sm">Brooklyn bridge photoshoot</h5>
                      <p className="banner-subtitle _fw-n _fs-sm _mt-5">$84 per person</p>
                    </div>
                  </div>
                </div>
                <div className="theme-inline-slider-item">
                  <div className="banner _br-4 banner-sqr banner-animate banner-animate-mask-in">
                    ...
                    <a className="banner-link" href="#" />
                    <div className="banner-caption _ph-15 _pb-15 _pt-60 banner-caption-bottom banner-caption-grad">
                      <h5 className="banner-title _fw-b _fs-sm">Pizza tour</h5>
                      <p className="banner-subtitle _fw-n _fs-sm _mt-5">$52 per person</p>
                    </div>
                  </div>
                </div>
                <div className="theme-inline-slider-item">
                  <div className="banner _br-4 banner-sqr banner-animate banner-animate-mask-in">
                    ...
                    <a className="banner-link" href="#" />
                    <div className="banner-caption _ph-15 _pb-15 _pt-60 banner-caption-bottom banner-caption-grad">
                      <h5 className="banner-title _fw-b _fs-sm">Shopping with a stylist</h5>
                      <p className="banner-subtitle _fw-n _fs-sm _mt-5">$5 per person</p>
                    </div>
                  </div>
                </div>
                <div className="theme-inline-slider-item">
                  <div className="banner _br-4 banner-sqr banner-animate banner-animate-mask-in">
                    ...
                    <a className="banner-link" href="#" />
                    <div className="banner-caption _ph-15 _pb-15 _pt-60 banner-caption-bottom banner-caption-grad">
                      <h5 className="banner-title _fw-b _fs-sm">Tea Ceremony</h5>
                      <p className="banner-subtitle _fw-n _fs-sm _mt-5">$84 per person</p>
                    </div>
                  </div>
                </div>
                <div className="theme-inline-slider-item">
                  <div className="banner _br-4 banner-sqr banner-animate banner-animate-mask-in">
                    ...
                    <a className="banner-link" href="#" />
                    <div className="banner-caption _ph-15 _pb-15 _pt-60 banner-caption-bottom banner-caption-grad">
                      <h5 className="banner-title _fw-b _fs-sm">Street graffiti tour</h5>
                      <p className="banner-subtitle _fw-n _fs-sm _mt-5">$80 per person</p>
                    </div>
                  </div>
                </div>
                <div className="theme-inline-slider-item">
                  <div className="banner _br-4 banner-sqr banner-animate banner-animate-mask-in">
                    ...
                    <a className="banner-link" href="#" />
                    <div className="banner-caption _ph-15 _pb-15 _pt-60 banner-caption-bottom banner-caption-grad">
                      <h5 className="banner-title _fw-b _fs-sm">Central park photoshoot</h5>
                      <p className="banner-subtitle _fw-n _fs-sm _mt-5">$11 per person</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="theme-page-section _pb-0 theme-page-section-lg">
            <div className="theme-page-section-header _ta-l _mb-20">
              <h5 className="theme-page-section-title theme-page-section-title-sm">Best Expericences in Paris</h5>
              <a className="theme-page-section-header-link _tt-n theme-page-section-header-link-rb" href="#">+ Find More</a>
            </div>
            <div className="theme-inline-slider row" data-gutter={10}>
              <div className="owl-carousel" data-items={5} data-loop="true" data-nav="true">
                <div className="theme-inline-slider-item">
                  <div className="banner _br-4 banner-sqr banner-animate banner-animate-mask-in">
                    ...
                    <a className="banner-link" href="#" />
                    <div className="banner-caption _ph-15 _pb-15 _pt-60 banner-caption-bottom banner-caption-grad">
                      <h5 className="banner-title _fw-b _fs-sm">Wine taste</h5>
                      <p className="banner-subtitle _fw-n _fs-sm _mt-5">$93 per person</p>
                    </div>
                  </div>
                </div>
                <div className="theme-inline-slider-item">
                  <div className="banner _br-4 banner-sqr banner-animate banner-animate-mask-in">
                    ...
                    <a className="banner-link" href="#" />
                    <div className="banner-caption _ph-15 _pb-15 _pt-60 banner-caption-bottom banner-caption-grad">
                      <h5 className="banner-title _fw-b _fs-sm">Cheese expericence</h5>
                      <p className="banner-subtitle _fw-n _fs-sm _mt-5">$65 per person</p>
                    </div>
                  </div>
                </div>
                <div className="theme-inline-slider-item">
                  <div className="banner _br-4 banner-sqr banner-animate banner-animate-mask-in">
                    ...
                    <a className="banner-link" href="#" />
                    <div className="banner-caption _ph-15 _pb-15 _pt-60 banner-caption-bottom banner-caption-grad">
                      <h5 className="banner-title _fw-b _fs-sm">Paris secrets tour</h5>
                      <p className="banner-subtitle _fw-n _fs-sm _mt-5">$34 per person</p>
                    </div>
                  </div>
                </div>
                <div className="theme-inline-slider-item">
                  <div className="banner _br-4 banner-sqr banner-animate banner-animate-mask-in">
                    ...
                    <a className="banner-link" href="#" />
                    <div className="banner-caption _ph-15 _pb-15 _pt-60 banner-caption-bottom banner-caption-grad">
                      <h5 className="banner-title _fw-b _fs-sm">Street dance workshop</h5>
                      <p className="banner-subtitle _fw-n _fs-sm _mt-5">$68 per person</p>
                    </div>
                  </div>
                </div>
                <div className="theme-inline-slider-item">
                  <div className="banner _br-4 banner-sqr banner-animate banner-animate-mask-in">
                    ...
                    <a className="banner-link" href="#" />
                    <div className="banner-caption _ph-15 _pb-15 _pt-60 banner-caption-bottom banner-caption-grad">
                      <h5 className="banner-title _fw-b _fs-sm">City bike tour</h5>
                      <p className="banner-subtitle _fw-n _fs-sm _mt-5">$93 per person</p>
                    </div>
                  </div>
                </div>
                <div className="theme-inline-slider-item">
                  <div className="banner _br-4 banner-sqr banner-animate banner-animate-mask-in">
                    ...
                    <a className="banner-link" href="#" />
                    <div className="banner-caption _ph-15 _pb-15 _pt-60 banner-caption-bottom banner-caption-grad">
                      <h5 className="banner-title _fw-b _fs-sm">Outdoor yoga class</h5>
                      <p className="banner-subtitle _fw-n _fs-sm _mt-5">$68 per person</p>
                    </div>
                  </div>
                </div>
          ...
          <div className="theme-page-section _pb-0 theme-page-section-lg">
            <div className="theme-page-section-header _ta-l _mb-20">
              <h5 className="theme-page-section-title theme-page-section-title-sm">Best Expericences in Tokyo</h5>
              <a className="theme-page-section-header-link _tt-n theme-page-section-header-link-rb" href="#">+ Find More</a>
            </div>
            <div className="theme-inline-slider row" data-gutter={10}>
              <div className="owl-carousel" data-items={5} data-loop="true" data-nav="true">
                <div className="theme-inline-slider-item">
                  <div className="banner _br-4 banner-sqr banner-animate banner-animate-mask-in">
                    ...
                    <a className="banner-link" href="#" />
                    <div className="banner-caption _ph-15 _pb-15 _pt-60 banner-caption-bottom banner-caption-grad">
                      <h5 className="banner-title _fw-b _fs-sm">Calligraphy workshop</h5>
                      <p className="banner-subtitle _fw-n _fs-sm _mt-5">$94 per person</p>
                    </div>
                  </div>
                </div>
                <div className="theme-inline-slider-item">
                  <div className="banner _br-4 banner-sqr banner-animate banner-animate-mask-in">
                    ...
                    <a className="banner-link" href="#" />
                    <div className="banner-caption _ph-15 _pb-15 _pt-60 banner-caption-bottom banner-caption-grad">
                      <h5 className="banner-title _fw-b _fs-sm">Dress up in kimono</h5>
                      <p className="banner-subtitle _fw-n _fs-sm _mt-5">$14 per person</p>
                    </div>
                  </div>
                </div>
                <div className="theme-inline-slider-item">
                  <div className="banner _br-4 banner-sqr banner-animate banner-animate-mask-in">
                    ...
                    <a className="banner-link" href="#" />
                    <div className="banner-caption _ph-15 _pb-15 _pt-60 banner-caption-bottom banner-caption-grad">
                      <h5 className="banner-title _fw-b _fs-sm">Kendo masterclass</h5>
                      <p className="banner-subtitle _fw-n _fs-sm _mt-5">$21 per person</p>
                    </div>
                  </div>
                </div>
                <div className="theme-inline-slider-item">
                  <div className="banner _br-4 banner-sqr banner-animate banner-animate-mask-in">
                    ...
                    <a className="banner-link" href="#" />
                    <div className="banner-caption _ph-15 _pb-15 _pt-60 banner-caption-bottom banner-caption-grad">
                      <h5 className="banner-title _fw-b _fs-sm">Tokyo street photography</h5>
                      <p className="banner-subtitle _fw-n _fs-sm _mt-5">$17 per person</p>
                    </div>
                  </div>
                </div>
                <div className="theme-inline-slider-item">
                  <div className="banner _br-4 banner-sqr banner-animate banner-animate-mask-in">
                    ...
                    <a className="banner-link" href="#" />
                    <div className="banner-caption _ph-15 _pb-15 _pt-60 banner-caption-bottom banner-caption-grad">
                      <h5 className="banner-title _fw-b _fs-sm">Homemade ramen</h5>
                      <p className="banner-subtitle _fw-n _fs-sm _mt-5">$61 per person</p>
                    </div>
                  </div>
                </div>
                <div className="theme-inline-slider-item">
                  <div className="banner _br-4 banner-sqr banner-animate banner-animate-mask-in">
                    ...
                    <a className="banner-link" href="#" />
                    <div className="banner-caption _ph-15 _pb-15 _pt-60 banner-caption-bottom banner-caption-grad">
                      <h5 className="banner-title _fw-b _fs-sm">Kayak tour</h5>
                      <p className="banner-subtitle _fw-n _fs-sm _mt-5">$90 per person</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="col-md-3">
                <div className="theme-footer-section theme-footer-">
                  ...
                  <div className="theme-footer-brand-text">
                    <p>Eleifend mus eros tellus netus conubia eleifend quis consectetur adipiscing vivamus nunc leo velit purus</p>
                    <p>Potenti eu at id dui sed varius at condimentum felis habitasse commodo cubilia potenti consequat</p>
                  </div>
                </div>
              </div>
