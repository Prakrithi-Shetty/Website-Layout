...
function ExpPage() {
  ...
  <div className="theme-hero-area">
    ...
    <div className="theme-hero-area-body">
      <div className="container">
        <div className="theme-item-page-header _pt-300 _pb-50 _pt-mob-100 theme-item-page-header-white">
          <div className="theme-item-page-header-body">
            <div className="theme-item-page-header-rating">
              <ul className="theme-item-page-header-rating-stars">
                <li>
              ...
              <p className="theme-item-page-header-rating-title">45 reviews</p>
            </div>
            <h1 className="theme-item-page-header-title _ff-d _fw-200">London Create Photography Course</h1>
            <div className="theme-item-page-header-price theme-item-page-header-price-xl">
              <p className="theme-item-page-header-price-body">
                <b>$90</b>
                <span>/ person</span>
              </p>
            </div>
            <ul className="theme-breadcrumbs">
              <li>
  ...
  <div className="theme-page-section">
    <div className="container">
      <div className="row row-col-static" id="sticky-parent" data-gutter={60}>
        <div className="col-md-8 ">
          <div className="theme-search-area _desk-h _mb-30 theme-search-area-vert">
            <div className="theme-search-area-header _mb-20 theme-search-area-header-sm">
              <h1 className="theme-search-area-title">Book Event</h1>
              <p className="theme-search-area-subtitle">Arcu risus malesuada penatibus a</p>
            </div>
            <div className="theme-search-area-form">
              <div className="theme-search-area-section theme-search-area-section-sm theme-search-area-section-curved">
                <div className="theme-search-area-section-inner">
                  ...
                  <input className="theme-search-area-section-input datePickerSingle _mob-h" defaultValue="Wed 06/27" type="text" />
                  <input className="theme-search-area-section-input _desk-h mobile-picker" defaultValue="2018-06-27" type="date" />
                </div>
              </div>
              <div className="theme-search-area-section theme-search-area-section-sm theme-search-area-section-curved quantity-selector" data-increment="Guests">
                <div className="theme-search-area-section-inner">
              ...
              <div className="theme-item-page-summary-price _mb-20">
                <a className="theme-item-page-summary-price-link" href="#summaryPriceCollapseMobile" data-toggle="collapse" aria-expanded="false" aria-controls="summaryPriceCollapseMobile">Show summary</a>
                <div className="collapse" id="summaryPriceCollapseMobile">
                  <ul className="theme-item-page-summary-price-list">
                    <li className="theme-item-page-summary-price-item">
                      <h5 className="theme-item-page-summary-price-item-title">2 Guests</h5>
                      <p className="theme-item-page-summary-price-item-subtitle" />
                      <p className="theme-item-page-summary-price-item-price">$184.00</p>
                    </li>
                    <li className="theme-item-page-summary-price-item">
                      <h5 className="theme-item-page-summary-price-item-title">Service fee</h5>
                      <p className="theme-item-page-summary-price-item-subtitle" />
                      <p className="theme-item-page-summary-price-item-price">$7.00</p>
                    </li>
                  </ul>
                </div>
                <p className="theme-item-page-summary-price-total">Total
                  <span>$191.00</span>
                </p>
              </div>
              <button className="theme-search-area-submit _mt-0 _tt-uc theme-search-area-submit-curved">Book Now</button>
            </div>
          </div>
          <div className="theme-item-page-tabs _mb-desk-30">
            <div className="tabbable">
              <ul className="nav nav-tabs nav-default nav-sqr" role="tablist">
              ...
              <div className="tab-content _pt-30">
                <div className="tab-pane active" id="HotelPageTabs-1" role="tab-panel">
                  <div className="theme-item-page-overview">
                    <div className="row row-col-mob-gap">
                      <div className="col-md-6 ">
                        <div className="row magnific-gallery row-col-gap" data-gutter={10}>
                          <div className="col-xs-3 ">
                            <div className="banner banner-sqr banner-">
                              <div className="banner-bg" style={{backgroundImage: 'url(./img/800x600.png)'}} />
                              <a className="banner-link" href="./img/800x600.png" />
                            </div>
                          </div>
                          <div className="col-xs-3 ">
                            <div className="banner banner-sqr banner-">
                      ...
                      <div className="col-md-6 ">
                        <div className="theme-item-page-desc">
                          <p>Faucibus dolor augue imperdiet adipiscing tellus at tortor eu mi fusce pharetra malesuada aliquet tempor euismod ultricies varius phasellus nibh</p>
                          <p>Bibendum torquent sem felis egestas convallis id ac nunc amet ac vehicula enim bibendum fusce etiam vel integer diam eleifend urna mattis ullamcorper lacus morbi sapien pretium luctus pulvinar integer</p>
                        </div>
                      </div>
                    </div>
                  </div>
                        ...
                        <div className="row" data-gutter={10}>
                          ...
                          <div className="col-md-9 ">
                            ...
                            <div className="theme-reviews-item-body">
                              <p className="theme-reviews-item-text">Netus gravida etiam sit et sapien pulvinar posuere gravida mollis laoreet sit eu sodales tristique condimentum cum sapien enim pharetra semper risus dui lorem habitasse quisque auctor dictum</p>
                            </div>
                          </div>
                        </div>
                      </article>
                      <article className="theme-reviews-item">
                        <div className="row" data-gutter={10}>
                          ...
                          <div className="col-md-9 ">
                            ...
                            <div className="theme-reviews-item-body">
                              <p className="theme-reviews-item-text">Risus molestie iaculis nullam lectus maecenas ridiculus eleifend proin libero aptent mattis penatibus mi tellus lacus nisl aptent senectus nostra gravida sed vivamus turpis nostra nostra et dapibus velit vivamus eros pulvinar mauris odio hendrerit venenatis consequat cubilia dis suspendisse</p>
                            </div>
                          </div>
                        </div>
                      </article>
                      <article className="theme-reviews-item">
                        <div className="row" data-gutter={10}>
                          ...
                          <div className="col-md-9 ">
                            ...
                            <div className="theme-reviews-item-body">
                              <p className="theme-reviews-item-text">Per facilisi cubilia sem magnis a interdum quis id per mollis nullam hac urna urna tempus ut nec donec ultricies convallis cum metus venenatis est blandit risus orci imperdiet consectetur penatibus arcu ipsum sed tempor ullamcorper sem eu</p>
                            </div>
                          </div>
                        </div>
                      </article>
                      <article className="theme-reviews-item">
                        <div className="row" data-gutter={10}>
                          ...
                          <div className="col-md-9 ">
                            ...
                            <div className="theme-reviews-item-body">
                              <p className="theme-reviews-item-text">Fringilla cras auctor purus vehicula vel pellentesque quisque elementum fringilla velit dis montes risus metus placerat molestie pretium rhoncus taciti cras ridiculus fringilla porta fames rhoncus mi ultricies viverra ac ut felis cubilia accumsan arcu class</p>
                            </div>
                          </div>
                        </div>
                      </article>
                      <article className="theme-reviews-item">
                        <div className="row" data-gutter={10}>
                          ...
                          <div className="col-md-9 ">
                            ...
                            <div className="theme-reviews-item-body">
                              <p className="theme-reviews-item-text">Sagittis sodales fringilla magna curabitur condimentum ad augue blandit adipiscing ad integer dapibus aliquam lobortis est vulputate dis conubia donec erat vehicula non suspendisse mollis mollis curae pharetra dignissim egestas pharetra viverra auctor accumsan lorem egestas</p>
                            </div>
                          </div>
                        </div>
                      </article>
        ...
        <div className="col-md-4 ">
          <div className="sticky-col _mob-h">
            <div className="theme-search-area theme-search-area-vert">
              <div className="theme-search-area-header _mb-20 theme-search-area-header-sm">
                <h1 className="theme-search-area-title">Book Event</h1>
                <p className="theme-search-area-subtitle">Consectetur magnis facilisis donec metus</p>
              </div>
              <div className="theme-search-area-form">
                <div className="theme-search-area-section theme-search-area-section-sm theme-search-area-section-curved">
                  <div className="theme-search-area-section-inner">
                ...
                <div className="theme-item-page-summary-price _mb-20">
                  <a className="theme-item-page-summary-price-link" href="#summaryPriceCollapse" data-toggle="collapse" aria-expanded="false" aria-controls="summaryPriceCollapse">Show summary</a>
                  <div className="collapse" id="summaryPriceCollapse">
                    <ul className="theme-item-page-summary-price-list">
                      <li className="theme-item-page-summary-price-item">
                        <h5 className="theme-item-page-summary-price-item-title">2 Guests</h5>
                        <p className="theme-item-page-summary-price-item-subtitle" />
        ...
        <div className="col-md-3">
          <div className="theme-footer-section theme-footer-">
            ...
            <div className="theme-footer-brand-text">
              <p>Fermentum nostra porta habitasse bibendum vestibulum habitasse eu class nam mollis amet diam integer netus</p>
              <p>Praesent nam eros turpis sagittis ut tortor suspendisse vehicula himenaeos bibendum at tellus imperdiet et</p>
            </div>
          </div>
        </div>
