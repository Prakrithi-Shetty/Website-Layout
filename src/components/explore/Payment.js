                      ...
                      <div className="row" data-gutter={20}>
                        <div className="col-md-9 ">
                          ...
                          <div className="theme-search-results-item-rating">
                            ...
                            <p className="theme-search-results-item-rating-title">167 reviews</p>
                          </div>
                          ...
                          <p className="theme-search-results-item-location">
                            <i className="fa fa-map-marker" />Midtown
                          </p>
                        </div>
                        <div className="col-md-3 ">
                  ...
                  <div className="theme-payment-page-sections-item">
                    <div className="theme-payment-page-booking">
                      <div className="theme-payment-page-booking-header">
                        <h3 className="theme-payment-page-booking-title">Total Price</h3>
                        ...
                        <p className="theme-payment-page-booking-price">$109.00</p>
                      </div>
                ...
                <div className="sticky-col">
                  <div className="theme-sidebar-section _mb-10">
                    ...
                    <ul className="theme-sidebar-section-summary-list">
                      <li>1 Guest</li>
                      <li>Date: Sat, Apr 07, 2018</li>
                      <li>Time: 11:00am - 13:00pm</li>
                    </ul>
                  </div>
                  <div className="theme-sidebar-section _mb-10">
                    ...
                    <div className="theme-sidebar-section-charges">
                      <ul className="theme-sidebar-section-charges-list">
                        <li className="theme-sidebar-section-charges-item">
                          <h5 className="theme-sidebar-section-charges-item-title">1 guest</h5>
                          <p className="theme-sidebar-section-charges-item-subtitle" />
                          <p className="theme-sidebar-section-charges-item-price">$92.00</p>
                        </li>
                        <li className="theme-sidebar-section-charges-item">
                          <h5 className="theme-sidebar-section-charges-item-title">Service fee</h5>
                          <p className="theme-sidebar-section-charges-item-subtitle" />
                          <p className="theme-sidebar-section-charges-item-price">$5.00</p>
                        </li>
                        <li className="theme-sidebar-section-charges-item">
                          <h5 className="theme-sidebar-section-charges-item-title">Taxes, Fees &amp; Surcharges</h5>
                          <p className="theme-sidebar-section-charges-item-subtitle" />
                          <p className="theme-sidebar-section-charges-item-price">$12.00</p>
                        </li>
                      </ul>
              ...
              <div className="col-md-3">
                <div className="theme-footer-section theme-footer-">
                  ...
                  <div className="theme-footer-brand-text">
                    <p>Sit sem maecenas at mollis volutpat per mus conubia habitasse habitasse est curae risus id</p>
                    <p>Lectus potenti duis praesent lacus conubia habitant semper augue semper vulputate taciti risus pretium ut</p>
                  </div>
                </div>
              </div>
