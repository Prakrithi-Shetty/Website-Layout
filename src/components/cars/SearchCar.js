              ...
              <div className="col-md-3">
                <div className="theme-footer-section theme-footer-">
                  ...
                  <div className="theme-footer-brand-text">
                    <p>Tempus purus semper senectus ridiculus class arcu cum quisque vitae porttitor suspendisse pretium est sit</p>
                    <p>Ad phasellus nunc sagittis sed luctus sagittis lorem convallis tincidunt habitasse quisque auctor nibh in</p>
                  </div>
                </div>
              </div>
              <div className="col-md-5">
