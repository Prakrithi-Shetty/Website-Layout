            ...
            <div className="row row-col-static row-col-mob-gap" id="sticky-parent" data-gutter={60}>
              <div className="col-md-8 ">
                <div className="theme-payment-page-sections">
                  ...
                  <div className="theme-payment-page-sections-item">
                    <h3 className="theme-payment-page-sections-item-title">Enter Driver Details</h3>
                  ...
                  <div className="theme-payment-page-sections-item">
                    <div className="theme-payment-page-booking">
                      <div className="theme-payment-page-booking-header">
                        <h3 className="theme-payment-page-booking-title">Total Price for 6 days</h3>
                        ...
                        <p className="theme-payment-page-booking-price">$224.00</p>
                      </div>
                    ...
                    <div className="theme-sidebar-section-charges">
                      <ul className="theme-sidebar-section-charges-list">
                        <li className="theme-sidebar-section-charges-item">
                          <h5 className="theme-sidebar-section-charges-item-title">6 days</h5>
                          <p className="theme-sidebar-section-charges-item-subtitle">Mazda CX-5</p>
                          <p className="theme-sidebar-section-charges-item-price">$192.00</p>
                        </li>
                        <li className="theme-sidebar-section-charges-item">
                          ...
                          <p className="theme-sidebar-section-charges-item-price">$32.00</p>
                        </li>
                      </ul>
              ...
              <div className="col-md-3">
                <div className="theme-footer-section theme-footer-">
                  ...
                  <div className="theme-footer-brand-text">
                    <p>Tincidunt pulvinar fermentum ornare augue nisi eget fusce sit fames convallis et suspendisse rutrum class</p>
                    <p>Torquent rhoncus mollis torquent per convallis duis pulvinar odio habitasse bibendum per viverra fames class</p>
                  </div>
                </div>
              </div>
