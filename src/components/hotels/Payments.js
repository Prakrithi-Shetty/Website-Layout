                ...
                <div className="theme-payment-page-sections">
                  ...
                  <div className="theme-payment-page-sections-item">
                    <div className="theme-search-results-item theme-payment-page-item-thumb">
                      <h5 className="theme-search-results-item-title">Standart King Room</h5>
                      <div className="row" data-gutter={20}>
                          ...
                          <div className="row" data-gutter={20}>
                            <div className="col-md-5 ">
                              <ul className="theme-search-results-item-hotel-room-features">
                                <li>
                                  <i className="fa fa-bed" />1 King bed
                                </li>
                                <li>
                                  <i className="fa fa-arrows-h" />250 squre feet
                                </li>
                                <li>
                                  <i className="fa fa-shower" />Private bathroom
                                </li>
                                <li>
                                  <i className="fa fa-wifi" />Free wifi
                                </li>
                                <li>
                                  <i className="fa fa-male" />2 Guests max
                                </li>
                              </ul>
                            </div>
                            <div className="col-md-5 ">
                              <ul className="theme-search-results-item-hotel-room-options">
                        ...
                        <div className="col-md-3 ">
                          <div className="theme-search-results-item-img-wrap">
                            <img className="theme-search-results-item-img" src="./img/350x232.png" alt="Image Alternative text" title="Image Title" />
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="theme-payment-page-sections-item">
                    <h3 className="theme-payment-page-sections-item-title">Enter Guest Details</h3>
                  ...
                  <div className="theme-payment-page-sections-item">
                    <div className="theme-payment-page-booking">
                      <div className="theme-payment-page-booking-header">
                        <h3 className="theme-payment-page-booking-title">Total Price for 6 nights</h3>
                        ...
                        <p className="theme-payment-page-booking-price">$739.00</p>
                      </div>
              ...
              <div className="col-md-4 ">
                <div className="sticky-col">
                  <div className="theme-sidebar-section _mb-10">
                    <h5 className="theme-sidebar-section-title">Hotel Pennsylvania</h5>
                    <img className="theme-sidebar-section-hotel-thumbnail-img" src="./img/50x50.png" alt="Image Alternative text" title="Image Title" />
                    <div className="theme-sidebar-section-hotel-thumbnail-caption">
                      <p className="theme-sidebar-section-hotel-thumbnail-rating">
                        <b>8.5 exellent</b>(2889 reviews)
                      </p>
                      <p className="theme-sidebar-section-hotel-thumbnail-address">401 7th Avenue, Chelsea, New York, NY 10001, USA</p>
                    </div>
                  </div>
                  <div className="theme-sidebar-section _mb-10">
                    ...
                    <div className="theme-sidebar-section-charges">
                      <ul className="theme-sidebar-section-charges-list">
                        <li className="theme-sidebar-section-charges-item">
                          <h5 className="theme-sidebar-section-charges-item-title">6 nights</h5>
                          <p className="theme-sidebar-section-charges-item-subtitle">2 Guests</p>
                          <p className="theme-sidebar-section-charges-item-price">$570.00</p>
                        </li>
                        <li className="theme-sidebar-section-charges-item">
                          ...
                          <p className="theme-sidebar-section-charges-item-price">$115.00</p>
                        </li>
                        <li className="theme-sidebar-section-charges-item">
                          <h5 className="theme-sidebar-section-charges-item-title">Resort fee</h5>
                          <p className="theme-sidebar-section-charges-item-subtitle">Payable at hotel</p>
                          <p className="theme-sidebar-section-charges-item-price">$54.00</p>
                        </li>
                      </ul>
              ...
              <div className="col-md-3">
                <div className="theme-footer-section theme-footer-">
                  ...
                  <div className="theme-footer-brand-text">
                    <p>Ornare condimentum tortor morbi habitasse natoque libero sollicitudin curabitur diam per fusce posuere fames per</p>
                    <p>Mus cras fusce morbi taciti odio felis accumsan dictumst donec nulla euismod libero ut eros</p>
                  </div>
                </div>
              </div>
              <div className="col-md-5">
