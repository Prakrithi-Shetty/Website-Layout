              ...
              <div className="col-md-3">
                <div className="theme-footer-section theme-footer-">
                  ...
                  <div className="theme-footer-brand-text">
                    <p>Proin dui pretium vulputate mollis placerat montes justo facilisi nostra mi integer suspendisse ut magna</p>
                    <p>Vestibulum placerat magna facilisi dolor non cras pharetra condimentum est purus rhoncus fames pulvinar nec</p>
                  </div>
                </div>
              </div>
