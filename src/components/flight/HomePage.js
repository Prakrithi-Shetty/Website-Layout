    ...
    return (
        ...
        <div className="theme-hero-area _h-desk-100vh">
          <div className="theme-hero-area-bg-wrap">
            ...
            <div className="theme-hero-area-grad-mask theme-hero-area-grad-mask-bold" />
            <div className="blur-area" data-bg-area="#" data-blur-area="#hero-search-form" data-blur={20} />
          </div>
                ...
                <div className="col-md-10 col-md-offset-1">
                  <div className="theme-search-area theme-search-area-stacked theme-search-area-white">
                    <div className="theme-search-area-header _ta-c">
                      <h1 className="theme-search-area-title theme-search-area-title-lg">Cheap Flights</h1>
                      <p className="theme-search-area-subtitle">Search hundreds of travel sites at once</p>
                    </div>
                      ...
                      <div className="row" data-gutter="none">
                        ...
                        <div className="col-md-6 ">
                          <div className="row" data-gutter="none">
                            ...
                            <div className="col-md-4 ">
                              <div className="theme-search-area-section theme-search-area-section-fade-white theme-search-area-section-mr theme-search-area-section-no-border theme-search-area-section-curved quantity-selector" data-increment="Passengers">
                                <div className="theme-search-area-section-inner">
        ...
        <div className="theme-page-section theme-page-section-xxl theme-page-section-dark">
          <div className="container">
            <div className="theme-page-section-header theme-page-section-header-white">
              ...
              <p className="theme-page-section-subtitle">Summer most popular flight routes</p>
            </div>
            <div className="theme-inline-slider row" data-gutter={10}>
              <div className="owl-carousel owl-carousel-nav-white" data-items={4} data-loop="true" data-nav="true">
                <div className="theme-inline-slider-item">
                  <div className="banner _h-45vh _br-4 banner-animate banner-animate-zoom-in">
                    <div className="banner-bg" style={{backgroundImage: 'url(./img/400x500.png)'}} />
                    <a className="banner-link" href="#" />
                    <div className="banner-caption _ta-c _pt-60 banner-caption-bottom banner-caption-grad">
                      <h5 className="banner-title">Pattaya City</h5>
                      <p className="banner-subtitle _fw-n">Thailand</p>
                    </div>
                  </div>
                </div>
                <div className="theme-inline-slider-item">
                  <div className="banner _h-45vh _br-4 banner-animate banner-animate-zoom-in">
                    ...
                    <a className="banner-link" href="#" />
                    <div className="banner-caption _ta-c _pt-60 banner-caption-bottom banner-caption-grad">
                      <h5 className="banner-title">San Francisco</h5>
                      <p className="banner-subtitle _fw-n">United States</p>
                    </div>
                  </div>
                </div>
                <div className="theme-inline-slider-item">
                  <div className="banner _h-45vh _br-4 banner-animate banner-animate-zoom-in">
                    ...
                    <a className="banner-link" href="#" />
                    <div className="banner-caption _ta-c _pt-60 banner-caption-bottom banner-caption-grad">
                      <h5 className="banner-title">Tokyo</h5>
                      <p className="banner-subtitle _fw-n">Japan</p>
                    </div>
                  </div>
                </div>
                <div className="theme-inline-slider-item">
                  <div className="banner _h-45vh _br-4 banner-animate banner-animate-zoom-in">
                    ...
                    <div className="banner-caption _ta-c _pt-60 banner-caption-bottom banner-caption-grad">
                      ...
                      <p className="banner-subtitle _fw-n">Australia</p>
                    </div>
                  </div>
                </div>
                <div className="theme-inline-slider-item">
                  <div className="banner _h-45vh _br-4 banner-animate banner-animate-zoom-in">
                    ...
                    <div className="banner-caption _ta-c _pt-60 banner-caption-bottom banner-caption-grad">
                      ...
                      <p className="banner-subtitle _fw-n">France</p>
                    </div>
                  </div>
                </div>
                <div className="theme-inline-slider-item">
                  <div className="banner _h-45vh _br-4 banner-animate banner-animate-zoom-in">
                    ...
                    <a className="banner-link" href="#" />
                    <div className="banner-caption _ta-c _pt-60 banner-caption-bottom banner-caption-grad">
                      <h5 className="banner-title">London</h5>
                      <p className="banner-subtitle _fw-n">United Kindom</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="theme-hero-area">
          <div className="theme-hero-area-bg-wrap">
            <div className="theme-hero-area-bg ws-action" style={{backgroundImage: 'url(./img/1500x801.png)'}} data-parallax="true" />
                  ...
                  <div className="col-md-6 col-md-offset-3">
                    <div className="theme-hero-text theme-hero-text-white theme-hero-text-center">
                      <div className="theme-hero-text-header">
                        <h2 className="theme-hero-text-title">Save Up to 70%</h2>
                        <p className="theme-hero-text-subtitle">Subscribe now and unlock our secret deals. Save up to 70% by getting access to our special offers for hotels, flights, cars, vacation rentals and travel experiences.</p>
                      </div>
                      <a className="btn _mt-20 _tt-uc btn-white btn-ghost btn-lg" href="#">Sign up now</a>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="theme-page-section theme-page-section-xxl theme-page-section-dark">
          <div className="container">
            <div className="theme-page-section-header theme-page-section-header-white">
              <h5 className="theme-page-section-title">Travel Inspirations</h5>
              <p className="theme-page-section-subtitle">Our latest travel tips, hacks and insights</p>
            </div>
            <div className="theme-inline-slider row" data-gutter={10}>
              <div className="owl-carousel owl-carousel-nav-white" data-items={4} data-loop="true" data-nav="true">
                <div className="theme-inline-slider-item">
                  <div className="theme-blog-item _br-4 theme-blog-item-white">
                    <a className="theme-blog-item-link" href="blog-post.html" />
                    <div className="banner _h-45vh  banner-">
                      <div className="banner-bg" style={{backgroundImage: 'url(./img/350x260.png)'}} />
                      <div className="banner-caption banner-caption-bottom banner-caption-">
                        <p className="theme-blog-item-time">day ago</p>
                        <h5 className="theme-blog-item-title">Booking hotel in India</h5>
                        <p className="theme-blog-item-desc">Amet cursus duis proin mauris quam quisque porttitor netus vulputate</p>
                      </div>
                    </div>
                  </div>
                </div>
                <div className="theme-inline-slider-item">
                  <div className="theme-blog-item _br-4 theme-blog-item-full">
                    <a className="theme-blog-item-link" href="blog-post.html" />
                    <div className="banner _h-45vh  banner-">
                      <div className="banner-bg" style={{backgroundImage: 'url(./img/350x435.png)'}} />
                      <div className="banner-caption banner-caption-bottom banner-caption-grad">
                        <p className="theme-blog-item-time">week ago</p>
                        <h5 className="theme-blog-item-title">Total Solar Eclipse</h5>
                        <p className="theme-blog-item-desc">Ultrices morbi aliquet hendrerit in iaculis tristique diam bibendum consequat</p>
                      </div>
                    </div>
                  </div>
                </div>
                <div className="theme-inline-slider-item">
                  <div className="theme-blog-item _br-4 theme-blog-item-white">
                    ...
                    <div className="banner _h-45vh  banner-">
                      <div className="banner-bg" style={{backgroundImage: 'url(./img/350x260.png)'}} />
                      <div className="banner-caption banner-caption-bottom banner-caption-">
                        <p className="theme-blog-item-time">2 weeks ago</p>
                        <h5 className="theme-blog-item-title">Lights of Venice</h5>
                        <p className="theme-blog-item-desc">Lacus arcu viverra senectus lectus nisi luctus lectus lobortis ultricies</p>
                      </div>
                    </div>
                  </div>
                </div>
                <div className="theme-inline-slider-item">
                  <div className="theme-blog-item _br-4 theme-blog-item-white">
                    ...
                    <div className="banner _h-45vh  banner-">
                      ...
                      <div className="banner-caption banner-caption-bottom banner-caption-">
                        <p className="theme-blog-item-time">2 weeks ago</p>
                        <h5 className="theme-blog-item-title">Alaska days</h5>
                        <p className="theme-blog-item-desc">Tristique mattis class consequat enim non tempor ad faucibus litora</p>
                      </div>
                    </div>
                  </div>
                </div>
                <div className="theme-inline-slider-item">
                  <div className="theme-blog-item _br-4 theme-blog-item-full">
                    ...
                    <div className="banner _h-45vh  banner-">
                      <div className="banner-bg" style={{backgroundImage: 'url(./img/350x435.png)'}} />
                      <div className="banner-caption banner-caption-bottom banner-caption-grad">
                        <p className="theme-blog-item-time">mounth ago</p>
                        <h5 className="theme-blog-item-title">Mix up your cabin classes</h5>
                        <p className="theme-blog-item-desc">Accumsan eleifend accumsan ante nisi interdum lacus malesuada netus mauris</p>
                      </div>
                    </div>
                  </div>
                </div>
